<?php
	...
	$breadcrumb[2]['url'] = url('backend/penjualan/create');
	if (isset($data)){
...
@section('content')
	<?php
		...
		if (isset($data)){
			...
			$method = "PUT";
			$mode = "Edit";
			$url = "backend/penjualan/".$data[0]->id;
		}
    ?>
	<div class="page-title">
		<div class="title_left">
			<h3>Pemakaian Barang - <?=$mode;?></h3>
		</div>
		<div class="title_right">
			<div class="col-md-4 col-sm-4 col-xs-8 form-group pull-right top_search">
                @include('backend.elements.back_button',array('url' => '/backend/penjualan'))
			</div>
        </div>
				...
				<div class="x_content">
                    {{ Form::open(['url' => $url, 'method' => $method,'class' => 'form-horizontal form-label-left']) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="no_nota" required="required" class="form-control col-md-7 col-xs-12" value="<?=$no_nota;?>" autofocus>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="field_wrapper">
                                    ...
                                    <div class="row" style="margin-bottom:10px;">
                                        ...
                                        <div class="col-sm-2">
                                            <a href="<?=url('backend/penjualan/barang/popup-media/'.$i);?>" class="btn btn-success browse-bahan-baku" title="Browse">Browse</a>
                                        </div>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row" style="margin-bottom:10px;">
                                        ...
                                        <div class="col-sm-2">
                                            <a href="<?=url('backend/penjualan/barang/popup-media/1');?>" class="btn btn-success browse-bahan-baku" title="Browse">Browse</a>
                                        </div>
                                        <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 offset-sm-6 text-right">
                                <a href="<?=url('/backend/penjualan')?>" class="btn btn-warning">Cancel</a>
